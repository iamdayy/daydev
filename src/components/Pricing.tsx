      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="fade-in text-3xl sm:text-4xl lg:text-5xl font-bold text-[#172033] mb-4">
            Investasi yang
            <span className="text-[#b45309]"> Sepadan</span>
          </h2>
        ...
        <div className="space-y-16">
          {pricingPlans.map((category) => {
            const CategoryIcon = categoryIcons[category.icon] ?? Mail;
            return (
              <div key={category.category} className="fade-in">
                ...
                <div className="flex flex-row gap-6 justify-start overflow-x-auto pb-2 snap-x">
                  {category.plans.map((plan) => (
                    <div
                      key={plan.name}
                      className={`card-hover relative rounded-2xl border-2 overflow-hidden snap-start shrink-0 min-w-[270px] max-w-[340px] flex-1 ${
                        plan.popular
                          ? "border-[#ea7b3c] shadow-xl"
                    ...
                    >
                      ...
                      >
                        <h4 className="font-bold text-[#172033] text-lg mb-1">
                          {plan.name}
                        </h4>
                        ...
                        <button
                          ...
                          className="w-full min-h-[48px] py-3 px-4 rounded-xl font-semibold text-sm transition-all duration-300"
                          style={
                            plan.popular
                              ? {
                        ...
                        {plan.demo && (
                          <a
                            ...
                            className="block mt-3 min-h-[44px] flex items-center justify-center text-center text-sm text-slate-500 hover:text-slate-700 transition-colors"
                          >
                            {plan.demo}
                          </a>
                        )}
        ...
        <div className="fade-in mt-16 bg-[#172033] rounded-2xl p-8 text-center text-white">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex min-h-[52px] items-center gap-2 bg-[#ea7b3c] text-[#172033] px-8 py-3 rounded-full font-bold hover:brightness-110 transition-all"
          >
