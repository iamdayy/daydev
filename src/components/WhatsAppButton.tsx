...
export default function WhatsAppButton() {
  ...
  return (
    <button
      onClick={handleClick}
      className="wa-bounce fixed bottom-6 right-6 z-50 w-14 h-14 bg-green-500 hover:bg-green-400 text-white rounded-full shadow-2xl shadow-green-500/40 flex items-center justify-center transition-all duration-300 hover:scale-110 group"
