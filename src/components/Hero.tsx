            ...
            <div className="mt-12 grid grid-cols-3 gap-6 max-w-sm mx-auto lg:mx-0">
              {[
                ...
                <div key={stat.label} className="text-center">
                  <div className="text-[#f39c12] font-bold text-2xl">{stat.value}</div>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="rocket-float relative">
                  ...
                  >
                    ...
                    {/* Window */}
                    <circle cx="100" cy="80" r="12" fill="#2c3e50" stroke="white" strokeWidth="2" />
                    <circle cx="100" cy="80" r="7" fill="#3498db" />
                    <circle cx="97" cy="77" r="2.5" fill="white" opacity="0.6" />
                    {/* Left fin */}
                    <path d="M72 120 L85 100 L85 135 Z" fill="#e67e22" />
                    {/* Right fin */}
                    <path d="M128 120 L115 100 L115 135 Z" fill="#e67e22" />
                    {/* Flame */}
                    <ellipse cx="100" cy="148" rx="14" ry="18" fill="#f39c12" opacity="0.9" />
                    <ellipse cx="100" cy="148" rx="9" ry="13" fill="#f1c40f" opacity="0.8" />
                    <ellipse cx="100" cy="148" rx="5" ry="8" fill="white" opacity="0.7" />
                    {/* Left small flame */}
                    <ellipse cx="88" cy="145" rx="5" ry="8" fill="#e67e22" opacity="0.6" />
                    {/* Right small flame */}
                    <ellipse cx="112" cy="145" rx="5" ry="8" fill="#e67e22" opacity="0.6" />
                  </svg>
