...
function StarRating({ count }: { count: number }) {
  return (
    <div className="flex gap-1" role="img" aria-label={`Rating ${count} dari 5`}>
      {[...Array(count)].map((_, i) => (
        <svg
          key={i}
          className="w-4 h-4 text-[#b45309] fill-current"
          viewBox="0 0 20 20"
          aria-hidden="true"
        >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="fade-in text-3xl sm:text-4xl lg:text-5xl font-bold text-[#172033] mb-4">
            Mereka Sudah
            <span className="text-[#b45309]"> Merasakan Manfaatnya</span>
          </h2>
          <p className="fade-in text-slate-600 text-lg max-w-2xl mx-auto">
            Cerita dari startup, UMKM, dan mahasiswa yang membangun bersama
            Daydev.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-gray-100">
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-semibold text-[#172033] text-sm truncate">
                    {t.name}
                  </div>
